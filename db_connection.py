...
userID: str = "018121309" #input('User ID [postgres]--> ') or "postgres"
...
password: str = "A&vmrj_t"#getpass.getpass(prompt=userID + ' password--> ')
host: str = "CECS-Postgresql"#input('hostname [localhost]--> ') or "localhost"
port: str = "5432"#input('port number [5432]--> ') or "5432"
database: str = "2023FallS01"#input('database [postgres]--> ') or "postgres"
